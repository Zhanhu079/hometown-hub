...
const CategoryCard = ({ title, bgColor, icon: Icon, description }) => {
    return (
      ...
      >
        ...
        {/* Centered title */}
        <h1 className="font-bold font-poppins text-2xl text-white z-10 text-center">{title}</h1>
  
        {/* Description text */}
        <p className="font-quicksand text-white z-10 text-center mt-2">{description}</p>
      </div>
    );
  };
